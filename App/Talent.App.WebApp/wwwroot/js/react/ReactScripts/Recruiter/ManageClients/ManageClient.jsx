...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://talentservicesprofile1.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://talentservicesidentity1.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
