...
export default class Experience extends React.Component {
    ...
    handleSave() {
        if (this.state.company === "" || this.state.position === "" || this.state.startDate.getTime() === new Date(0).getTime() || this.state.endDate.getTime() === new Date(0).getTime() || this.state.responsibilities === "") {
            ...
            var joined = this.state.experiences.concat({ id: this.state.index, company: this.state.company, position: this.state.position, responsibilities: this.state.responsibilities, start: this.state.startDate, end: this.state.endDate });
