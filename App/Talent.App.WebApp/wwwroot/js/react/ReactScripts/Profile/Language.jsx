...
export default class Language extends React.Component {
    ...
    handleSave() {
        if (this.state.newLangLevel === "" || this.state.newLangName === "") {
            ...
            var joined = this.state.languages.concat({ id: this.state.index, name: this.state.newLangName, level: this.state.newLangLevel });
    ...
    handleUpdate(id, name, level) {
        console.log("Language.jsx: handleUpdate....");
    ...
    handleDelete(id) {
        console.log("Language.jsx:handleDelete....");
        console.log(id);
        for (let i = 0; i < this.state.languages.length; i++) {
            if (this.state.languages[i].id === id) {
                            ...
                            <Table.Body >
                                {languageData.map((language) => {
                                    if (!language.isDeleted) {
                                        console.log("!language.isDeleted ")
